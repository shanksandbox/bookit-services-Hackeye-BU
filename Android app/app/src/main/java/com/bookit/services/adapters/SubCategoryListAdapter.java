...
import com.bookit.services.SubCategoryServicesActivity;
...
import com.bookit.services.viewwidgets.CircleImageView;
...
public class SubCategoryListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SubCategoryListAdapter(Context mContext, List<DAOServiceSubCategories.SubcategoryList> category_list) {
        this.mContext = mContext;
        this.category_list = category_list;
    }

    public SubCategoryListAdapter(Activity mActivity, Context mContext, ArrayList<ProviderListData.ProviderList> itemsData, int viewType) {
...
//    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        providerViewHolder.tvSubcatname.setText(category_list.get(position).getSubcategoryName());
        ...
        providerViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent callSubCategoryList = new Intent(mContext, SubCategoryServicesActivity.class);
//                callSubCategoryList.putExtra(AppConstants.CatID, category_list.get(position).getId());
                ...
                callSubCategoryList.putExtra(AppConstants.CATNAME, category_list.get(position).getSubcategoryName());
